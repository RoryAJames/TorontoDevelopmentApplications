...
def show_about_page():
    ...
    st.write("Use Machine Learning to predict the outcome of an application! Enter an applications parameters and get an estmated likeliehood that this application will be approved.")
